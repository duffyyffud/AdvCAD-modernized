#!/usr/bin/env python3
"""
Simple OpenGL test with PyQt5 - draws a rotating triangle
"""
...
try:
    ...
    print("✓ QOpenGLWidget import successful")
except ImportError as e:
    print(f"✗ QOpenGLWidget import failed: {e}")
    sys.exit(1)
...
class SimpleOpenGLWidget(QOpenGLWidget):
    """Minimal OpenGL widget that draws a rotating triangle"""
...
class TestWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PyQt5 OpenGL Test - Rotating Triangle")
        ...
        # Info label
        info_label = QLabel("OpenGL Test: You should see a rotating triangle")
        layout.addWidget(info_label)
        
        # OpenGL widget
        try:
            self.gl_widget = SimpleOpenGLWidget()
...
def main():
    print("Starting PyQt5 OpenGL test...")
